...
testname="real_with_correction_overlap"
...
get_error<-function(weightSolutions, testname){
  ...
  Errors[7] = abs(1/100 - weightSolutions[[7]][1,1]) + abs(1/100 - weightSolutions[[7]][2,1]) + abs(1/100 - weightSolutions[[7]][3,1])
